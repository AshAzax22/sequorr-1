...
function StepIndicator({ step, currentStep, onClickStep, disableStepIndicators, icon, isExtra }) {
  ...
  return (
    <motion.div onClick={handleClick} className="step-indicator" animate={status} initial={false}>
      <motion.div
        variants={{
          inactive: { scale: 1, backgroundColor: '#333333', color: '#FFFFFF' },
          active: { scale: 1, backgroundColor: '#2EEE34', color: '#000000' },
          complete: { scale: 1, backgroundColor: '#2EEE34', color: '#000000' }
        }}
...
function StepConnector({ isComplete }) {
  const lineVariants = {
    ...
    complete: { width: '100%', backgroundColor: '#2EEE34' }
  };
